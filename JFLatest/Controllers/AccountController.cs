        ...
        public ActionResult RegisterEmployer(RegisterEmployer model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    membershipService.CreateUserAndAccount(emp, model.Password);//create membership account for the user
                    WebSecurity.Login(model.email, model.Password); //log user in
                    return RedirectToAction("Index", "Home");
                }
